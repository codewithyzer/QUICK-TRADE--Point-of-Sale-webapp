...
export default function LargeCard(props) {
  return (
    <div className="flex max-h-90 min-h-75 max-w-120 min-w-100 cursor-pointer flex-col overflow-hidden rounded-md border-gray-400 bg-white transition-all duration-50 hover:border-1">
