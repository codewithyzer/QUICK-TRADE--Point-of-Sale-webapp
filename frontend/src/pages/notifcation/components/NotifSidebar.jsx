...
export default function NotifSidebar() {
  ...
  return (
    <section className="font-poppins border-thirdary fixed top-0 bottom-0 left-0 z-20 flex w-[284px] flex-col items-center border-r-1 bg-white">
      ...
      <div className="font-poppins flex h-[250px] w-full flex-col items-start justify-between pl-[20px]">
        ...
        <Link to={"/notifications"}>
          <button className={pageActiveStyle} name="notification-page-toggler">
